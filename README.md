# study-k8s-docker
here is a book about k8s,doker. 这是一本关于容器，比如k8s docker等的书。
## 作者的计算机知识项目
...
[![Stargazers over time](https://starchart.cc/shgopher/study-k8s-docker.svg)](https://starchart.cc/shgopher/study-k8s-docker)
